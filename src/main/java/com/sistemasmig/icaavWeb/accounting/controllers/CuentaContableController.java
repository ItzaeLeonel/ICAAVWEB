...
public class CuentaContableController {
    ...
    @Operation(summary = "Search CuentaContable by CuentaContable Attributes", description = "This service retrieve CuentaContable information filter by CuentaContable Attributes", tags = { "cuentaContable" })
    @ApiResponses(value = {
    ...
    ResponseEntity<PagedResponse<CuentaContable>> getCuentaContable(@RequestHeader(value = "token", required = true) @Parameter(description="MIG SSO Token - UUID") String token,
    ...
    @Operation(summary = "Search CuentaContable by CuentaContable Id", description = "This service retrieve CuentaContable information filter by CuentaContable Id", tags = { "cuentaContable" })
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "successful operation", content = @Content(array = @ArraySchema(schema = @Schema(implementation = CuentaContable.class)))),
        @ApiResponse(responseCode = "400", description = "bad request", content = @Content(array = @ArraySchema(schema = @Schema(implementation = ErrorDetails.class))))
    })
    @RequestMapping(value = "/{id}", method = RequestMethod.GET)
    public CuentaContable getById(@RequestHeader(value = "token", required = true) @Parameter(description="MIG SSO Token - UUID") String token,
                                                     @PathVariable(value = "id") @Parameter(description="CuentaContable Id - Integer") Integer cuentaContableId) throws EntityNotExistentException, BadRequestException, NoAccessGrantedException  {
    ...
    @Operation(summary = "Create CuentaContable", description = "This service create a new CuentaContable Object", tags = { "cuentaContable" })
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "successful operation", content = @Content(array = @ArraySchema(schema = @Schema(implementation = CuentaContable.class)))),
        @ApiResponse(responseCode = "400", description = "bad request", content = @Content(array = @ArraySchema(schema = @Schema(implementation = ErrorDetails.class))))
    })
    @RequestMapping(method = RequestMethod.POST)
    public ResponseEntity<CuentaContable> createCuentaContable(@RequestHeader(value = "token", required = true) @Parameter(description="MIG SSO Token - UUID") String token,
            @Valid @RequestBody(required = true) @Parameter(description="CuentaContable object - json") CuentaContable cuentaContable) throws BusinessLogicException, ExistentEntityException, BadRequestException, EntityNotExistentException, NoAccessGrantedException {
        try{
    ...
    @Operation(summary = "Update CuentaContable", description = "This service updates a persited CuentaContable Object", tags = { "cuentaContable" })
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "successful operation", content = @Content(array = @ArraySchema(schema = @Schema(implementation = CuentaContable.class)))),
        @ApiResponse(responseCode = "400", description = "bad request", content = @Content(array = @ArraySchema(schema = @Schema(implementation = ErrorDetails.class))))
    })
    @RequestMapping(value = "/{id}", method = RequestMethod.PATCH)
    public ResponseEntity<CuentaContable> updateCuentaContable(@RequestHeader(value = "token", required = true) @Parameter(description="MIG SSO Token - UUID") String token,
                                                 @PathVariable(value = "id") @Parameter(description="CuentaContable Id - Integer") Integer cuentaContableId,
                                                 @Valid @RequestBody(required = true) @Parameter(description="CuentaContable object - json") CuentaContable cuentaContable, BindingResult bindingResult) throws BusinessLogicException, BadRequestException, EntityNotExistentException, ExistentEntityException, NoAccessGrantedException {
        try{
            ...
            return new ResponseEntity<>(cuentaContableService.updateCuentaContable(cuentaContableId, cuentaContable), HttpStatus.OK);
        }catch (Exception ble) {
    ...
    @Operation(summary = "Delete CuentaContable", description = "This service deletes (Logically) a persited CuentaContable Object", tags = { "cuentaContable" })
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "successful operation", content = @Content(array = @ArraySchema(schema = @Schema(implementation = CuentaContable.class)))),
        @ApiResponse(responseCode = "400", description = "bad request", content = @Content(array = @ArraySchema(schema = @Schema(implementation = ErrorDetails.class))))
    })
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE)
    public ResponseEntity<Boolean> deleteCuentaContable(@RequestHeader(value = "token", required = true) @Parameter(description="MIG SSO Token - UUID") String token,
                                                 @PathVariable(value = "id") @Parameter(description="CuentaContable Id - Integer") Integer cuentaContableId) throws Exception, BusinessLogicException, EntityNotExistentException, ExistentEntityException, NoAccessGrantedException {
        try{
    ...
    public List<ListCuentasContables> getByDatosEmpresaSP(@RequestHeader(value = "token", required = true) @Parameter(description="MIG SSO Token - UUID") String token,
    ...
    public InsertCuentaC CreateByCuentaContableSP(@RequestHeader(value = "token", required = true) @Parameter(description="MIG SSO Token - UUID") String token,
