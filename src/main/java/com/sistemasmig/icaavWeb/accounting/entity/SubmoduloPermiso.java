...
@Entity
@Table(name = "ST_ADM_TR_SUBMODULO_PERMISO")
@Data
@AllArgsConstructor
@NoArgsConstructor
public class SubmoduloPermiso {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "ID_SUBMODULO_PERMISO", unique = true, columnDefinition = "INT(11)", updatable = false, nullable = false)
    private Integer id;
    @ManyToOne
