...
import com.sistemasmig.icaavWeb.accounting.repositories.AsignacionesClasificacionCtasRepository;
/**
 *
 * @author Julio
 */
@Component
public class AsignacionesClasificacionCtasManager {
    
    @Autowired
    private AsignacionesClasificacionCtasRepository asignacionesClasificacionCtasRepository;
    ...
    public AsignacionClasificacionCtas getById(Integer id) throws EntityNotExistentException {
    	return asignacionesClasificacionCtasRepository.findById(id).orElse(null);
    }
    ...
    public PagedResponse<AsignacionClasificacionCtas> getAsignacionClasificacionCtas(AsignacionClasificacionCtas filter, Paging paging){
        ...
        if(filter.getClasificacion()!=null){
                ...
                if(filter.getClasificacion().getFechaModificacion()!=null ){
                predicates.add(cb.equal(root.get("clasificacion").get("fechaModificacion"), filter.getClasificacion().getFechaModificacion()));
	...
	public AsignacionClasificacionCtas save(AsignacionClasificacionCtas entity) {
		return asignacionesClasificacionCtasRepository.save(entity);
	}

	@Transactional
	public AsignacionClasificacionCtas update(AsignacionClasificacionCtas entity) {
		return asignacionesClasificacionCtasRepository.save(entity);
	}

	@Transactional
	public void delete(AsignacionClasificacionCtas entity) {
		asignacionesClasificacionCtasRepository.save(entity);
	}

	public List<AsignacionClasificacionCtas> findAll() {
		return asignacionesClasificacionCtasRepository.findAll();
	}
