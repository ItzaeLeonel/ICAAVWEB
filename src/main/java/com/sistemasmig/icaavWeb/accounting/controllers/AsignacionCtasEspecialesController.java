...
public class AsignacionCtasEspecialesController {
	...
	@Operation(summary = "Search AsignacionCtasEspeciales by AsignacionCtasEspeciales Attributes", description = "This service retrieve AsignacionCtasEspeciales information filter by CuentasEspeciales Attributes", tags = {
			"asignacionCtasEspeciales" })
	@ApiResponses(value = {
	...
	ResponseEntity<PagedResponse<AsignacionCtasEspeciales>> getAsignacionCtasEspeciales(
		...
		try {
			...
			return new ResponseEntity<>(
					asignacionCtasEspecialesService.getAsignacionCtasEspeciales(asignacionCtasEspeciales, paging),
					HttpStatus.OK);
		} catch (Exception ex) {
	...
	@Operation(summary = "Search AsignacionCtasEspeciales by AsignacionCtasEspeciales Id", description = "This service retrieve AsignacionCtasEspeciales information filter by AsignacionCtasEspeciales Id", tags = {
			"asignacionCtasEspeciales" })
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "successful operation", content = @Content(array = @ArraySchema(schema = @Schema(implementation = CuentasEspeciales.class)))),
			@ApiResponse(responseCode = "400", description = "bad request", content = @Content(array = @ArraySchema(schema = @Schema(implementation = ErrorDetails.class)))) })
	@RequestMapping(value = "/{id}", method = RequestMethod.GET)
	public AsignacionCtasEspeciales getById(
			@RequestHeader(value = "token", required = true) @Parameter(description = "MIG SSO Token - UUID") String token,
	...
	@Operation(summary = "Create AsignacionCtasEspeciales", description = "This service create a new AsignacionCtasEspeciales Object", tags = {
			"AsignacionCtasEspeciales" })
	@ApiResponses(value = {
	...
	public ResponseEntity<AsignacionCtasEspeciales> createAsignacionCtasEspeciales(
			@RequestHeader(value = "token", required = true) @Parameter(description = "MIG SSO Token - UUID") String token,
			@Valid @RequestBody(required = true) @Parameter(description = "AsignacionCtasEspeciales object - json") AsignacionCtasEspeciales asignacionCtasEspeciales)
		...
		try {
			 ...
			 */
			return new ResponseEntity<>(
					asignacionCtasEspecialesService.createAsignacionCtasEspeciales(asignacionCtasEspeciales),
					HttpStatus.CREATED);
		} catch (Exception ex) {
			throw new BadRequestException(ex.getMessage());
		}
	...
	@Operation(summary = "Update AsignacionCtasEspeciales", description = "This service updates a persited AsignacionCtasEspeciales Object", tags = {
			"asignacionCtasEspeciales" })
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "successful operation", content = @Content(array = @ArraySchema(schema = @Schema(implementation = AsignacionCtasEspeciales.class)))),
			@ApiResponse(responseCode = "400", description = "bad request", content = @Content(array = @ArraySchema(schema = @Schema(implementation = ErrorDetails.class)))) })
	...
	public ResponseEntity<AsignacionCtasEspeciales> updateAsignacionCtasEspeciales(
			@RequestHeader(value = "token", required = true) @Parameter(description = "MIG SSO Token - UUID") String token,
			@PathVariable(value = "id") @Parameter(description = "AsignacionCtasEspeciales Id - Integer") Integer asignacionCtasEspecialesId,
			@Valid @RequestBody(required = true) @Parameter(description = "AsignacionCtasEspeciales object - json") AsignacionCtasEspeciales asignacionCtasEspeciales,
		...
		try {
			...
			return new ResponseEntity<>(asignacionCtasEspecialesService.updateAsignacionCtasEspeciales(
					asignacionCtasEspecialesId, asignacionCtasEspeciales), HttpStatus.OK);
		} catch (Exception ble) {
	...
	@Operation(summary = "Delete AsignacionCtasEspeciales", description = "This service deletes (Logically) a persited AsignacionCtasEspeciales Object", tags = {
			"asignacionCtasEspeciales" })
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "successful operation", content = @Content(array = @ArraySchema(schema = @Schema(implementation = AsignacionCtasEspeciales.class)))),
			@ApiResponse(responseCode = "400", description = "bad request", content = @Content(array = @ArraySchema(schema = @Schema(implementation = ErrorDetails.class)))) })
	@RequestMapping(value = "/{id}", method = RequestMethod.DELETE)
	public ResponseEntity<Boolean> deleteAsignacionCtasEspeciales(
			@RequestHeader(value = "token", required = true) @Parameter(description = "MIG SSO Token - UUID") String token,
			@PathVariable(value = "id") @Parameter(description = "AsignacionCtasEspeciales Id - Integer") Integer asignacionCtasEspecialesId)
	...
	public AsignacionCuentasEspDemo UpdateByCuentaEspecial(
			@RequestHeader(value = "token", required = true) @Parameter(description = "MIG SSO Token - UUID") String token,
			@Parameter(description = "idEmpresa Id - String") Integer pr_id_empresa,
			@Parameter(description = "CuentasEspeciales Id - String") Integer pr_id_cta_especial,
			@Parameter(description = "CuentaContable Id - String") Integer pr_id_cuenta_contable)
			throws EntityNotExistentException, BadRequestException, NoAccessGrantedException {
		try {
	...
	public ResponseEntity<List<AsignacionCtasEspeciales>> findDigitoCuentacontable(
			@RequestParam String tipoCuenta) {
		return new ResponseEntity<>(asignacionCtasEspecialesService.findTipoCuentaEspecial(tipoCuenta), HttpStatus.OK);
	}
