...
import com.sistemasmig.icaavWeb.accounting.models.dto.CuentasContablesInsertSP;
 ...
 * @author Julio
 */
public interface CuentaContableInsertRepository extends JpaRepository<CuentasContablesInsertSP, Integer>{
    
    @Procedure(name = "sp_con_cuentas_contables_i")
     Map<String, ?> Insertprocedurecuentascont(@Param("pr_id_grupo_empresa") Integer pr_id_grupo_empresa,
                        ...
                        @Param("pr_cuenta_complementaria") Integer pr_cuenta_complementaria);
